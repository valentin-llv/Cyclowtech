        ...
        <div id="content" class="absolute top-0 left-0 h-full w-full overflow-x-hidden overflow-y-auto">
            ...
            <div class="relative w-full mt-24 md:mt-32 pb-32">
                <div class="relative pl-14 pr-14 lg:pr-0 lg:pl-0 lg:w-10/12 m-auto pt-2">
                    ...
                    <h2 class="relative font-bold text-5xl md:text-6xl">Ajouter un articles: Couverture et titre</h2>
                    ...
                    <div class="w-full lg:w-4/12 m-auto mt-20">
                        <form action="../php-worker/create-article.php" method="POST" class="flex flex-col" enctype="multipart/form-data">
                            ...
                            <input name="name" required class="mt-5 outline-none border-2 rounded-md border-100 p-5 text-3xl color-100" type="text" placeholder="Nom de l'article ..." />
