    ...
    <div class="overflow-hidden w-full h-full absolute">
        <div id="content" class="absolute top-0 left-0 h-full w-full overflow-x-hidden overflow-y-auto">
            ...
            <div class="relative w-full mt-24 md:mt-32 pb-32">
                <div class="pl-14 pr-14 lg:pr-0 lg:pl-0 lg:w-10/12 m-auto pt-12 lg:pt-20">
                    <h2 class="relative font-bold text-5xl md:text-6xl"><?php echo $translations_fr['contact_us_title']; ?></h2>
                    <div class="h-2 w-20 bg-100 rounded-full ml-1 mt-5"></div>

                    <p class="text-2xl md:text-3xl mt-14">
                        <b><?php echo $translations_fr['contact_us_mail']; ?></h2></b>: contact@cyclowtech.org
                    </p>

                    <p class="text-2xl md:text-3xl mt-4">
                        <b><?php echo $translations_fr['contact_us_phone']; ?></b>: (+33) 6&nbsp;52&nbsp;38&nbsp;69&nbsp;46
                    </p>

                    <p class="text-2xl md:text-3xl mt-4">
                        <b><?php echo $translations_fr['contact_us_adress']; ?></b>: 64 avenue Jean Portalis - 37200 Tours - France
                    </p>

                    <div class="mt-10 relative flex flex-row flex-wrap">
                        <a href="mailto:contact@cyclowtech.org" target="_blank">
                            <div class="mb-6 mr-10 cta-home-button border-2 border-dashed border-100 bg-900 hover:border-transparent duration-100 p-5 flex flex-row">
                                <p class="text-2xl md:text-3xl color-100 duration-100"><?php echo $translations_fr['contact_us_action_button_1']; ?></p>
                        ...
                        <a href="tel:0652386946">
                            <div class="w-max mb-6 mr-10 cta-home-button border-2 border-dashed border-100 bg-900 hover:border-transparent duration-100 p-5 flex flex-row">
                                <p class="text-2xl md:text-3xl color-100 duration-100"><?php echo $translations_fr['contact_us_action_button_2']; ?></p>
